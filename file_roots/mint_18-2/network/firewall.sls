...
include:
  - mint_18-2.network.firewalling-pkgs
...
/usr/local/sbin/reset_iptables.sh:
  file.managed:
    ...
    - source: salt://mint_18-2/network/usr/local/sbin/reset_iptables.sh
    - user: root
    - group: root
    - mode: 750
...
/etc/cron.d/reset-iptables:
  file.managed:
    ...
    - source: salt://mint_18-2/network//etc/cron.d/reset-iptables
    - user: root
    - group: root
    - mode: 644
